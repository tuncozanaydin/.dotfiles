...
#+begin_src emacs-lisp :tangle config.el
  ...
  (custom-set-faces
   ...
   ;; Optional extras
   '(font-lock-doc-face ((t (:slant italic))))           ;; docstrings
   '(font-lock-builtin-face ((t (:slant italic))))       ;; like `print`, `len`, etc.
   '(font-lock-type-face ((t (:slant italic))))          ;; types like `int`, `str`
   )

  (setq-default line-spacing 0.15) ;; float = adds proportional space
  ;; or (setq-default line-spacing 2) ;; integer = fixed extra pixels
  ...
  ;; (set-fontset-font t 'symbol (font-spec :family "Cascadia Code") nil 'prepend))
