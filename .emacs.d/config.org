...
* GUI
  #+begin_src emacs-lisp
    ...
    (set-face-attribute 'default nil :font "Dank Mono" :height 140)
    (set-face-attribute 'fixed-pitch nil :font "Dank Mono" :height 140)
    (set-face-attribute 'variable-pitch nil :family "Dank Mono" :height 140 :weight 'regular)
