...
#+begin_src emacs-lisp :tangle config.el
  ...
  ;; Make the highlighted row in Ranger stand out (buffer-local remap)
  (with-eval-after-load 'ranger
    (defun toa/ranger-boost-hl-line ()
      (hl-line-mode 1)
      ;; Remap only in this buffer; doesn't affect other modes
      (face-remap-add-relative 'hl-line '(:background "#44475a" :extend t)))
    (add-hook 'ranger-mode-hook #'toa/ranger-boost-hl-line))
