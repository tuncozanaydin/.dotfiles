...
#+begin_src emacs-lisp :tangle config.el
  ...
  (global-set-key (kbd "C-c f h") #'toa/frame-left-half)
  (global-set-key (kbd "C-c f l") #'toa/frame-right-half)
  (global-set-key (kbd "C-c f j") #'toa/frame-maximize)
  (global-set-key (kbd "C-c f k") #'toa/frame-restore)
#+end_src
...
#+begin_src emacs-lisp :tangle config.el
  ...
  (global-set-key (kbd "C-c s s") #'toa/toggle-eshell-popup)
#+end_src
