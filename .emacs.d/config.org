...
#+begin_src emacs-lisp :tangle config.el
  ...
  (use-package doom-modeline
    ...
    (doom-modeline-def-modeline 'my-python-line
    ...
    (add-hook 'python-mode-hook
              (lambda () (doom-modeline-set-modeline 'my-python-line t))))

  ;; Refresh Doom Modeline when Conda environment changes
  (defun my/update-conda-env-modeline ()
    "Update Doom Modeline when Conda environment changes."
    (doom-modeline-set-modeline 'my-python-line t)
    (force-mode-line-update t))

  (add-hook 'conda-postactivate-hook #'my/update-conda-env-modeline)
  (add-hook 'conda-postdeactivate-hook #'my/update-conda-env-modeline)
